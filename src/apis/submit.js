...
function getParamsFromState(state) {
    ...
    params.append('license_info[license_photo]', state.basicInfo.businessLicense.urlValue || '')
    params.append('license_info[license_name]', state.basicInfo.companyName || '')
    params.append('license_info[license_id]', state.basicInfo.businessLicenseNo || '')
    params.append('license_info[license_address]', state.basicInfo.businessLicenseAddress || '')
    params.append('license_info[license_time_start]', state.basicInfo.businessLicensePeriod?.period[0].format('YYYY-MM-DD') || '')
    params.append('license_info[license_time_end]', state.basicInfo.businessLicensePeriod?.longTerm === true ? '长期' : state.basicInfo?.businessLicensePeriod.period[1].format('YYYY-MM-DD'))
